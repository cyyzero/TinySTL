...
// Using static const int x = N is a better choice.
// but at that time, few compliers accepted the former.
    ...
    static char *chunk_alloc(std::size_t size, int &nobjs)
    {
        ...
        else
        {
            ...
            if (start_free == nullptr)
            {
                ...
                for (i = size; i < (std::size_t)__MAX_BYTE; i += (std::size_t)__ALIGN)
                {
