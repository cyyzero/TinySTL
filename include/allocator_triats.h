...
//                otherwise std::std::pointer_traits<pointer>::rebind<const value_type>
ALIAS_USING_SFINAE(const_pointer, typename std::pointer_traits<pointer>::template rebind<const value_type>)
    using const_pointer = _const_pointer;

// void_pointer: Alloc::void_pointer if present, otherwise std::std::pointer_traits<pointer>::rebind<void>
ALIAS_USING_SFINAE(void_pointer, typename std::pointer_traits<pointer>::template rebind<void>)
    using void_pointer = _void_pointer;

// const_void_pointer: Alloc::const_void_pointer if present, otherwise std::std::pointer_traits<pointer>::rebind<const void>
ALIAS_USING_SFINAE(const_void_pointer, typename std::pointer_traits<pointer>::template rebind<const void>)
    using const_void_pointer = _const_void_pointer;

// different_type: Alloc::difference_type if present, otherwise std::std::pointer_traits<pointer>::difference_type
ALIAS_USING_SFINAE(difference_type, typename std::pointer_traits<pointer>::difference_type)
